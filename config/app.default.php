...
return [
    ...
    'EmailTransport' => [
        'default' => [
            'className' => env('EMAIL_TRANSPORT_CLASSNAME', 'Cake\Mailer\Transport\MailTransport'),
            /*
             * The following keys are used in SMTP transports:
             */
            'host' => env('EMAIL_TRANSPORT_HOST', null),
            'port' => env('EMAIL_TRANSPORT_PORT', null),
            'timeout' => 30,
            'username' => env('EMAIL_TRANSPORT_USERNAME', null),
            'password' => env('EMAIL_TRANSPORT_PASSWORD', null),
            'client' => null,
            'tls' => env('EMAIL_TRANSPORT_TLS', null),
