...
<div class="container-fluid padding0">
    <?= $this->element('banner_tit', ['text' => 'Chúng tôi cung cấp các giải pháp tốt nhất để giải quyết các vấn đề của khách hàng.']) ?>
...
<div class="container">
    <div class="row">
        <div class="col-md-12 list-system">
            ...
            <p>
                Phát triển dịch vụ liên quan đến hệ thống thương mại điện tử.<br />
                Tạo Application chuyên mua bán qua mạng.<br />
                Quản lý các sản phẩm mà người dùng cuối đã mua với thời gian thực.<br />
