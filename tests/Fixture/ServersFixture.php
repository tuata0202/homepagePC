...
class ServersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ip' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'max_user' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'modified' => '2018-09-11 08:14:05',
                'created' => '2018-09-11 08:14:05',
                'deleted' => '2018-09-11 08:14:05',
                'user_action' => 1,
                'user_created' => 1
            ],
        ];
