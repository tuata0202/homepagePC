...
class AccountsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '1: Active 2: Demo 0: Blocked', 'precision' => null, 'autoIncrement' => null],
        'exp_demo_date' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'package_id' => 1,
                'status' => 1,
                'exp_demo_date' => '2018-09-12 06:32:04',
                'modified' => '2018-09-12 06:32:04',
                'created' => '2018-09-12 06:32:04',
                'deleted' => '2018-09-12 06:32:04',
                'user_action' => 1,
                'user_created' => 1
            ],
        ];
