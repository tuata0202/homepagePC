...
$(document).ready(function () {
  // menu toggle
  $("ul.sub-menu").parent().append("<span class='toggle_nav_button'><i class='fa fa-angle-down' aria-hidden='true'></i></span>");
  $(".toggle_nav_button").click(
    function () {
      var link = $(this);
      $(this).parent().find("ul.sub-menu").slideToggle(100, "linear", function () {
        if ($(this).is(':visible')) {
          // link.text('-');
          link.children().remove('i.fa-angle-down');
          link.append('<i class="fa fa-angle-up" aria-hidden="true"></i>');
        } else {
          link.children().remove('i.fa-angle-up');
          link.append('<i class="fa fa-angle-down" aria-hidden="true"></i>');
          // link.text('+');
        }
      });
    });
...
jQuery(window).on('scroll', function () {
  ...
  if ($(this).scrollTop() > 80) {
    ...
    $('#main-menu-header').addClass('navbar-fixed-top');
    $('#logo-first-load').hide();
    $('#logo-second-load').show();
  } else {
    $('#main-menu').removeClass('navbar-fixed-top');
    $('#main-menu-header').removeClass('navbar-fixed-top');
    $('#logo-first-load').show();
    $('#logo-second-load').hide();
  }
